...
class GameHighScore(Object):
    ...
    @staticmethod
    def _parse(client, game_high_score: raw.functions.HighScore, users: dict) -> "GameHighScore":
    ...
    @staticmethod
    def _parse_action(client, service: raw.functions.MessageService, users: dict):
        return GameHighScore(
