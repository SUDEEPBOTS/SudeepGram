...
class GroupCallParticipantVideoSourceGroup(TLObject):  # type: ignore
    ...
    Returns:
        :obj:`GroupCallParticipantVideoSourceGroup <pyrogram.raw.base.GroupCallParticipantVideoSourceGroup>`
    """

    __slots__: List[str] = ["semantics", "sources"]

    ID = 0xdcb118b7
    QUALNAME = "functions.GroupCallParticipantVideoSourceGroup"
