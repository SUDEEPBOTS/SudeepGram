...
class LoginUrl(Object):
    ...
    @staticmethod
    def read(b: "raw.functions.KeyboardButtonUrlAuth") -> "LoginUrl":
        return LoginUrl(
            url=b.url,
    ...
    def write(self, text: str, bot: "raw.functions.InputUser"):
        return raw.functions.InputKeyboardButtonUrlAuth(
            text=text,
            url=self.url,
            bot=bot,
